<?php
namespace Krish\Productattach\Ui\Component\Listing\Column;
    ...
    public function prepareDataSource(array $dataSource)
    {
        if(isset($dataSource['data']['items'])) {
            ...
            foreach($dataSource['data']['items'] as & $item) {
                ...
                // if($fileExt){
                //     $iconImage = $this->_assetRepo->getUrl('Krish_Productattach::images/'.$fileExt.'.png');
                //     $fileIcon = "<a href=".$this->_dataHelper->getBaseUrl().'/'.$file." target='_blank'><img src='".$iconImage."' /></a>";
                // }else{
                //     $iconImage = $this->_assetRepo->getUrl('Krish_Productattach::images/unknown.png');
                ...
                if($item[$fieldName] != '') {
                    if($fileExt){
                        $url = $this->_assetRepo->getUrl('Krish_Productattach::images/'.$fileExt.'.png');
                    }else{
                        $url = $this->_assetRepo->getUrl('Krish_Productattach::images/unknown.png');
                    }
